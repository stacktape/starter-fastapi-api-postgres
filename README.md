...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-fastapi-api-postgres)

- HTTP API built with [FastAPI](https://fastapi.tiangolo.com/), the modern Python web framework.
- Runs as an ASGI [web service](https://docs.stacktape.com/compute-resources/web-services/) with a Postgres
  [relational database](https://docs.stacktape.com/resources/relational-databases/). Uses SQLAlchemy for database access
...
```bash
stacktape init --starterId fastapi-api-postgres
```
